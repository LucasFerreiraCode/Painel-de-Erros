var errosWhatsApp = [
    ...
    { codigo: "131026", categoria: "Falha", descricao: "Mensagem não entregue", causa: "A mensagem não foi entregue porque o número de destino pode não possuir WhatsApp ativo, estar bloqueado, localizado em uma região restrita, não ter aceitado os termos mais recentes do aplicativo ou estar utilizando uma versão desatualizada.", solucao: "Verificar se os parâmetros estão corretos e reprocessar.", resposta: "O sistema identificou uma falha genérica 131026.", acao: "Investigar logs e reenviar após correção." },
    { codigo: "131031", categoria: "Falha", descricao: "Erro não específico 131031", causa: "Erro retornado pela API do WhatsApp.", solucao: "Verificar se os parâmetros estão corretos e reprocessar.", resposta: "O sistema identificou uma falha genérica 131031.", acao: "Investigar logs e reenviar após correção." },
    { codigo: "131053", categoria: "Falha", descricao: "Erro não específico 131053", causa: "Erro retornado pela API do WhatsApp.", solucao: "Verificar se os parâmetros estão corretos e reprocessar.", resposta: "O sistema identificou uma falha genérica 131053.", acao: "Investigar logs e reenviar após correção." },
